...
conclude_skat_file <- "result/single-snps-test/conclude/conclusion-glm-0.0.csv"
conclude_out_file <- "result/single-snps-test/conclude/conclusion-GLMthreshold.csv"
...
conclude_skat_mx <- matrix(0, col_number-2, 4)
